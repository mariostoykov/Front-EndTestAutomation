...
namespace WorkingWithWindows
{
    ...
    public class SwitchingWindowsTests
    {
        ...
        public void HandleMultipleWindows()
        {
            ...
            Assert.That(newWindowContent.Contains("New Window"),
            ...
            Assert.That(originalWindowContent.Contains("Opening a new window"),
        ...
        [Test, Order(2)]
        public void HandleNotSuchWindowException()
        {
            // Launch the browser and open the URL
            driver.Url = "https://the-internet.herokuapp.com/windows";
