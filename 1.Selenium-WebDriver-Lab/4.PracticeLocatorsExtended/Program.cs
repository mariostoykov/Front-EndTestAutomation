...
{
    public class LocatorsWithAssertion
    {
        ...
        public void TestCssLocators()
        {
            ...
            Assert.That(firstNameField.GetAttribute("value"), Is.EqualTo("Vincent"));
            Console.WriteLine("First name field by name value: " + firstNameField.GetAttribute("value"));
        ...
        public void TestXPath()
        {
            ...
            Assert.That(submitButton.GetAttribute("value"), Is.EqualTo("Submit"));
            Console.WriteLine("Submit checkbox type: " + submitButton.GetAttribute("value"));
